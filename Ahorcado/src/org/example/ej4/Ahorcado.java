...
public class Ahorcado extends Activity {
	...
	private String[] diccionario = { "MERLUZO", "ZOPENCO", "PUCH",
			...
			"ULTRASHOW", "CLOROFORMO", "INTRINSECO", "REIZIGUER", "CURVA",
			...
			"GRAGEA", "HARAPO", "HEDONISMO", "HIEL", "ISOTOPO", "HECATOMBE",
			"ANDRAJOSO", "LINGOTAZO", "RAGATANGA", "HIPOTIROIDISMO",
			"MARLBORO", "MIJATOVIC", "BECKHAM", "BECKENBAUER", "PICHICHI",
			"CURRUPIPI", "DEUTERONOMIO", "ATAHUALPA", "CAMARLENGO", "POPEYE",
			"CISTITIS", "CACHIMBA", "PERSIANA", "RUMANO", "HACKER", "HOSTING",
			"GUADALUPE", "CONCHINCHILLA", "BENALMADENA", "CHURUMBEL",
			"ASQUEROSO", "HUMANOIDE", "PANQUETE", "PIRULETA", "MACHOTA",
			"MEDIAPUNTA", "CHIRIGOTA", "ARRAY", "INDECISO" };
